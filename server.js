...
const tutorSchema = new mongoose.Schema({
  ...
  teachingLevels: {
    ...
    jc: {
      ...
      knowledgeInquiry: Boolean,
      h1Math: Boolean,
      h2Math: Boolean,
      h2furtherMath: Boolean,
      h1Physics: Boolean,
      h2Physics: Boolean,
      h1Chemistry: Boolean,
      h2Chemistry: Boolean,
      ...
      h1Geography: Boolean,
      h2Geography: Boolean,
      h1Literature: Boolean,
      h2Literature: Boolean,
      h1Chinese: Boolean,
      h2Chinese: Boolean,
      h1Malay: Boolean,
      h2Malay: Boolean,
    ...
    computing: { python: Boolean, java: Boolean, cpp:Boolean, cSharp: Boolean, webDevelopment: Boolean, dataScience: Boolean, aiAndMachineLearning: Boolean, mobileAppDevelopment: Boolean, photoshop: Boolean, videoEditing: Boolean }
  },
